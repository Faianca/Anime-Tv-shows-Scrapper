...
class Frame(wx.Frame):
    ...
    def on_add_file(self, event):
        ...
        self.mplayer.Loadfile("http://gateway2.play44.net/at/nw/terra_formars_-_09.mp4?st=f2HiwrttEnU6N4syZqKQfQ&e=1416961609&server=playpanda.net")
